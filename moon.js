...
$(function(){if(typeof window.performance==='undefined'){window.performance={};}
...
function startSpeedingAt(){stopSpeeding()
var startX=window.pageXOffset
